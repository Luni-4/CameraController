...
#define GP_MIME_ARW "image/x-sony-arw"
    ...
    typedef enum
    {
        ...
        GP_FILE_TYPE_RAW,     /**< The raw mode of a file, for instance the raw
                               * bayer data for cameras     where postprocessing is
                               * done     in the driver. The RAW files of modern
                               * DSLRs     are     GP_FILE_TYPE_NORMAL usually. */
        GP_FILE_TYPE_AUDIO,   /**< The audio view of a file. Perhaps an embedded
                                 comment or similar. */
        GP_FILE_TYPE_EXIF,    /**< The embedded EXIF data of an image. */
        GP_FILE_TYPE_METADATA /**< The metadata of a file, like Metadata of
    ...
    typedef enum
    {
        ...
        GP_FILE_ACCESSTYPE_FD,     /**< File is associated with a UNIX
                                      filedescriptor. */
        GP_FILE_ACCESSTYPE_HANDLER /**< File is associated with a programmatic
                                      handler. */
    ...
    int gp_file_new_from_handler(CameraFile **file, CameraFileHandler *handler,
                                 void *priv);
